...
# Figure 3.5(b), 3.6(b), 3.7(b) and tables 6.4 - 6.7 of the manuscript
...
def FF(alpha,beta,delta,gamma):
    """Calculates the long term filling fraction"""
...
reactions_stoch("X7+X4->X1,X7+X5->X2,X7+X6->X3,X1->X7+X4,X2->X7+X5,X3->X7+X6,X7->0X7,0X7->X7") 
...
#####################################################
##### Check Filling Fraction: tables 6.4 - 6.7 ######
############## and calculate CV #####################
#####################################################
...
###############################################################
######## Plot number of all substances: Fig. 3.5(b) ###########
###############################################################
...
###############################################################
### Plot number of all substances except p: Fig. 3.5(b) #######
###############################################################
...
###############################################################
#### Plot number of slots and receptors: Fig. 3.5(b) ##########
###############################################################
